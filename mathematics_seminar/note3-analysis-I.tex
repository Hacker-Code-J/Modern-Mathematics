...
\input{grad-math-preamble-analysis}
\input{tcolorbox}
\input{theorem}
\input{tikz}
...
\newpage
\begin{note}[\color{red}Existence of $\sqrt{2}$]
...
\defbox[Supremum and Infimum]{\begin{definition*}
	Let $\varnothing\neq S\subseteq\R$.
	\begin{enumerate}[(1)]
		\item The number $\beta\in\R$ is the \hl{\textbf{supremum}} (or the \hl{\textbf{least upper bound}}) of $S$ if and only if \begin{enumerate}[(i)]
		...
		\item The number $\alpha\in\R$ is the \hl{\textbf{infimum}} (or the \hl{\textbf{greatest lower bound}}) of $S$ if and only if \begin{enumerate}[(i)]
...
\end{theorem*}}
\begin{center}
\input{../tikz/grad-math-tikz/grad-math-3-archi}
\end{center}
\begin{proof}
...
\] 
%By \hyperlink{pro1}{\textbf{Proposition 1}}, 
...
\end{corollary*}}
\begin{center}
\input{../tikz/grad-math-tikz/grad-math-3-archi2}
\end{center}
\begin{proof}
...
\end{corollary*}}
\begin{center}
	\input{../tikz/grad-math-tikz/grad-math-3-archi3}
\end{center}
\begin{proof}
