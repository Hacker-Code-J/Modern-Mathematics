...
\defbox[Injection and Surjection]{\begin{definition*}
	Let $f:A\to B$ is a function from $A$ to $B$. \begin{itemize}
		...
		\] An \textbf{injection} is a function s.t. the output uniquely determines its input.
		...
		\] A \textbf{surjection} is a function s.t. every element of $B$ is related to by some element of $A$.
	\end{itemize}
\end{definition*}}
\begin{remark*}
...
\defbox[Composition of Functions]{\begin{definition*}
	...
	(f_2\circ f_1)(a):= f_2(f_1(a))\quad\text{for all $a\in A$.}
	\]
\end{definition*}}
%\begin{remark*}
%\ \begin{itemize}
