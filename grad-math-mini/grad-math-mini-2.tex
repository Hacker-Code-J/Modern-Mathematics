...
\begin{proof}
	...
	\begin{enumerate}[(i)]
		...
		\text{id}_X:X\to X\quad\text{defined by}\quad x\mapsto x=\id_X
...
\defbox[Union and Intersection of an Indexed Family]{\begin{definition*}
	Let $I$ and $S$ are sets, and let $\Gen{A_i}_{i\in}$ be an indexed family in $S$. \begin{itemize}
		...
		\bigcap_{i\in I}A_i:=\set{x\in S:\forall i\in I,\ x\in A_i}.
		\]
	\end{itemize}
\end{definition*}}
\begin{remark*}
...
\thmbox[]{\begin{theorem}
	...
	\] where $[x]_{\mathcal{R}}=\set{y\in S:x\relation y}$. Then $\mathcal{P}$ forms the partition of $S$.
\end{theorem}}
\begin{proof}
