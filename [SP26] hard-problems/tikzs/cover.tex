...
%				20/{ECDLP}/{[x]P=Q},
		...
		{
			\sffamily
			\fontsize{18}{22}\selectfont \textcolor{textlight}{\bfseries Mathematical Foundations for Post-Quantum Cryptography}\\[0.55em]
			\fontsize{13}{17}\selectfont \textcolor{textdim}{Factorization $\cdot$ Discrete Logarithm $\cdot$ Lattices $\cdot$ Codes $\cdot$ Isogenies $\cdot$ Multivariate $\cdot$ Hash }\\[1.10em]
			\fontsize{15}{19}\selectfont \bfseries\textcolor{white}{Ji, Yonghyeon}
		};
