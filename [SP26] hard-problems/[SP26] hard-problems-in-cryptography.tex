...
\begin{tcolorbox}[colback=themecolor, colframe=themecolor, sharp corners]
	...
	\Huge \textbf{Hard Problems in Cryptography}\\
	\vspace{0.5em}
	\Large \textit{Mathematical Foundations for Classical and Post-Quantum Cryptography }
\end{tcolorbox}
...
\newpage\input{sections/01-preliminaries.tex}	
%\newpage\input{sections/IFP.tex}	
%\newpage\input{sections/DLP.tex}
\newpage\input{sections/Lattice.tex}
\newpage\input{sections/Code.tex}
%	
%	\newpage
%	\section{Isogenies (Supersingular Isogeny Problems)}
%	\input{sections/Isogeny.tex}
%	
%	\newpage
