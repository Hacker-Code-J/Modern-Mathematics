...
\begin{scope}
	...
	% triple zero at 0.3
	\fill[green!60!black] (0.45,0) circle(2.3pt) node[above right] {$a=0.3$};
	\node[green!60!black] at (-1.7,1.7) {zero of order $3$};
	
	\node[align=left] at (0,-2.7) {$\displaystyle
		f_+(z)=(z-0.3)^3,\quad \#Z-\#P=3$};
\end{scope}
...
\begin{scope}[shift={(7.2,0)}]
	...
	({
		( (cos(\x r)-0.3)^3 - 3*(cos(\x r)-0.3)*(sin(\x r))^2 )
	},
	{
		( 3*(cos(\x r)-0.3)^2*(sin(\x r)) - (sin(\x r))^3 )
	});
	\node[violet] at (2.0,1.6) {$f_+(C)$};
