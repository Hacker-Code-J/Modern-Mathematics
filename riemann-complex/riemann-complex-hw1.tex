...
\begin{definition*}
	...
	t \mapsto \gamma(t) = \big(x_1(t), x_2(t), \dots, x_n(t)\big).
	\] Then the \textbf{arc length} $s$ of the curve \( C \) from \( t = a \) to \( t = b \) is defined by \[
	\boxed{
		s := \int_a^b \left\| \gamma'(t) \right\|\, dt},\quad\text{where}\; \left\| \gamma'(t) \right\| = \sqrt{ \left( \frac{d}{dt}x_1(t) \right)^2 + \left( \frac{d}{dt}x_2(t) \right)^2 + \cdots + \left( \frac{d}{dt}x_n(t) \right)^2 }.
	\]
\end{definition*}}
\begin{center}
