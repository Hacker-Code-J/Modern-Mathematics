...
\begin{scope}[shift={(0,6)}]
	...
	%	\node[below,align=center] at (0,-2.5) {
...
\begin{scope}[shift={(0,1)}]
	\node[above] at (0,2.1) {$F([z_0:z_1])=[z_0:z_1]$};
...
%	\draw[->,thick,magenta] (AMI) to (BMI);
	...
	\draw[->,thick]
	(AS) .. controls (-0.3,-1.0) and (0.3,1.0) .. (BN);
	
%	% ∞ -> 0  (curve going "down and under" between spheres)
%	\draw[->,thick]
%	(AN) .. controls (-0.3,1.0) and (0.3,-1.0) .. (BS);
%	
%	% 1 -> 1  (front equator)
%	\draw[->,thick]
%	(AE) .. controls (-0.2,0.2) and (0.2,0.2) .. (BE);
%	
%	% -1 -> -1  (back equator, slight up curve)
%	\draw[->,thick]
%	(AW) .. controls (-0.2,0.0) and (0.2,0.0) .. (BW);
\end{scope}
