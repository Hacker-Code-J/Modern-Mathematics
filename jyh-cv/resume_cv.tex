...
\name{M.S.}{Ji, Yong-hyeon}
\address{Department of Cyber Security, Koomin University}
\mobile{(+82) 010-0000-0000}

\email{hacker3740@gmail.com}
%\homepage{www.posquit0.com}
\github{hacker\_code\_j}
%\linkedin{posquit0}
%\skype{skypeid}
...
\position{Information Security{\enskip\cdotp\enskip}Cryptology{\enskip\cdotp\enskip}Computer Science{\enskip\cdotp\enskip}Mathematics} % Your expertise/fields
\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Ji, Yong-hyeon}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
