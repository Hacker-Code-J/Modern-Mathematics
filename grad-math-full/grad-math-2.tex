	...
	Let $I$ and $S$ are sets, and let $\Gen{A_i}_{i\in}$ be an indexed family in $S$. \begin{itemize}
		...
		\displaystyle\boxed{\bigcup_{i\in I}A_i:=\set{x\in S:\exists i\in I\ \text{such that}\ x\in A_i}}$. \begin{center}
			\begin{tikzpicture}[scale=.65]
				\draw[thick, fill=blue, fill opacity=0.2] (0,0) circle (1.5);
				\draw[thick, fill=red, fill opacity=0.2] (1.5,0) circle (1.5);
				\draw[thick, fill=green, fill opacity=0.2] (0.75,.75) circle (1.5);
				\draw[thick, fill=yellow, fill opacity=0.2] (0.75,-.75) circle (1.5);
				\foreach \points in {(-1,0), (.75,0), (1.75,0), (-.25,0), (2.5,0)}
%				,(.75, 1) ,(.75, 1.75) , (.75, -1), (.75, -1.75), (-.25, 1),
%				(1.75, 1), (-.25, -1), (1.75, -1)}
				\fill[red] \points circle (3pt);
			\end{tikzpicture}
		\end{center}
		...
		\begin{center}
			\begin{tikzpicture}[scale=.65]
				...
				\draw[thick, fill=green, fill opacity=0.2] (0.75,.75) circle (1.5);
				\draw[thick, fill=yellow, fill opacity=0.2] (0.75,-.75) circle (1.5);
				\foreach \points in {(.25,0), (.5,.25), (.75,-.1), (1,-.5), (1.25,.1)}
			\fill[red] \points circle (3pt);
		\end{tikzpicture}
	\end{center}
	\end{itemize}
...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
\thmbox[Fundamental Theorem on Equivalence Relations]{\begin{theorem}
	...
	\] Then $\mathcal{P}$ forms the partition of $S$.
\end{theorem}}
\begin{center}
...
\newpage
\thmbox[Relation Induced by Partition is Equivalence]{\begin{theorem}
