...
\begin{note}[Illustration]
	\ \begin{center}\begin{tikzpicture}[scale=.5]
			...
			\filldraw[thick, cyan!50] (0,0) ellipse (4.25 and 2.5);
			\draw[thick, line width = .25mm] (0,0) ellipse (4.25 and 2.5);
			
			\filldraw[thick, magenta!50] (\x,0) ellipse (4.5 and 2.5);
			\draw[thick, line width = .25mm] (\x,0) ellipse (4.5 and 2.5);
			\filldraw[thick, cyan!50] (\x,0) ellipse (4.25 and 1);
			\draw[thick, line width = .25mm] (\x,0) ellipse (4.25 and 1);
			
			% Draw the arrows representing the function
			\draw[-Stealth, thick] (-\x + .5, 4.5) -- (-.5,4.5) node[midway, above] {$f_1$};
			\draw[-Stealth, thick] (.5, 4.5) -- (\x - .5,4.5) node[midway, above] {$f_2$};
			...
			\draw[dashed, thick, line width= .5mm, color=cyan] (-\x + .25, \ellmajor) -- (.25, 2.5);
			\draw[dashed, thick, line width= .5mm, color=cyan] (-\x + .25, -\ellmajor) -- (.25, -2.5);
			
			\node at (\x, 1.5) {$\img{f_2}=f_2[B]$};
			\draw[dashed, thick, line width= .5mm, color=magenta] (0.25, \ellmajor) -- (\x + .25, 2.5);
			\draw[dashed, thick, line width= .5mm, color=magenta] (0.25, -\ellmajor) -- (\x + .25, -2.5);
			
			\node at (\x, 0) {$\img{f_2\circ f_1}=f_2[f_1[A]]$};
			\draw[dashed, thick, line width= .5mm, color=cyan] (0.25, 2.5) -- (\x + .25, 1);
			\draw[dashed, thick, line width= .5mm, color=cyan] (0.25, -2.5) -- (\x + .25, -1);
			
			\node at (-\x, -4.5) {$\text{Dom}(f_1)$};
			\node at (0, -4.5) {$\text{Cdm}(f_1)=\text{Dom}(f_2)$};
			\node at (\x, -4.5) {$\text{Cdm}(f_2)$};
		\end{tikzpicture}
	\end{center}
\end{note}
\vfill
