...
\newpage\noindent
What is $\textcolor{red}{\pm1}$ for the set $\textcolor{blue}{S=\set{(-1)^n:n\in\N}}$?
\begin{center}
...
\end{tikzpicture}
\end{center}
What is $\textcolor{red}{\pm1}$ for the set $\textcolor{blue}{S=\set{(-1)^n+\frac{1}{n}:n\in\N}}$?
\begin{center}
\begin{tikzpicture}[scale=.75]
	\begin{axis}[
		xlabel={$n$},
...
Let $\set{x_n}_{i=1}^\infty$ be a sequence in $\R$. Define \begin{align*}
	s_1 &=\sup\set{x_1,x_2,x_3,x_4,\dots}, \\
	s_1 &=\sup\set{\hspace{.5cm} x_2,x_3,x_4,\dots}, \\
	\vdots &\\
	s_n &=\sup\set{\hspace{1cm} x_n,x_{n+1},\dots}.
\end{align*}
...
\begin{enumerate}[(1)]
	\item The \textbf{limit superior} of the sequence, denoted by $\limsup\limits_{n \to \infty} x_n$ is defined as \[
	\limsup\limits_{n \to \infty} x_n:=\lim\limits_{n\to\infty}\sup_{k\geq n}x_k,
