...
\begin{tikzpicture}[
	...
	\begin{axis}[
		...
		\node[blue, right] at (axis cs: 0.6, 0.5) {$C_1$};
		...
		\node[red, below] at (axis cs: 0.5, 0) {$C_2 (a)$};
		\node[red, right] at (axis cs: 1, 0.5) {$C_2 (b)$};
		
		% 5. POINTS
		\fill[black] (axis cs: 0,0) circle(2pt) node[below left] {Start $(0,0)$};
		\fill[black] (axis cs: 1,1) circle(2pt) node[above right] {End $(1,1)$};
