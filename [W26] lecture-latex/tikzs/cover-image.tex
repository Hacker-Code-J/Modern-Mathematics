...
%		\node[textdim, font=\tiny, anchor=north, yshift=-10pt] {TikZ Render Engine};
	...
	at ([xshift=1in, yshift=-7.5in]current page.north west) 
	{
		...
		\fontsize{50}{60}\selectfont \bfseries \textcolor{accentcyan}{Technical \LaTeX}
	};
	...
	{
		\sffamily
		\fontsize{20}{24}\selectfont \textcolor{textlight}{\bfseries Modern Typography and Vector Graphics}\\[0.5em]
